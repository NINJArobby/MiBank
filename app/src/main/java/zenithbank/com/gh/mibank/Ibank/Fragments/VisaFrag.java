 ...
 */
public class VisaFrag extends Fragment
{
    ...
    ArrayList<String> acctList, acctListCard;
                             ...
                             Bundle savedInstanceState)
    {
        ...
        acctList = ibankDatabaseEngine.getCardAccounts();
        acctListCard = ibankDatabaseEngine.getAccounts();
        ...
        try
        {
            ...
            toAcct = (Spinner) view.findViewById(R.id.SpnToAccts);
            ...
            ArrayAdapter<String> dataAdapter1 = new ArrayAdapter<>
                    (getActivity(), android.R.layout.simple_spinner_item, acctListCard);
            dataAdapter1.setDropDownViewResource
                    (android.R.layout.simple_spinner_dropdown_item);

            fromAcct.setAdapter(dataAdapter1);
            ...
            floatingActionButton.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    try
                    {
                        ...
                        {
                            Toast.makeText(getActivity(), "Visa Account not set",
                                    Toast.LENGTH_SHORT).show();
                        }
